...
activationOpts.mergeProximityRadius_mm = 0.05; % <---edit: proximity radius (mm) for merge rejection (~13 px)
...
policyTag = sprintf([ ...
    ...
    'spots=%d|gaps=%.4g|rsmc=%d|wall=%d|oxOn=%d|ox0=%.4g|ox1=%.4g|oy0=%.4g|oy1=%.4g|', ...
